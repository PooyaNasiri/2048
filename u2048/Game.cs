...
namespace _2048
{
    public class Game
    {
        ...
        public static GameState currentGameState = GameState.eGame;
        ...
        public Game()
        {
            ...
            label1.Location = new System.Drawing.Point(12, 578);
            label1.Name = "label1";
        ...
        public static System.Windows.Forms.Label label1 = new System.Windows.Forms.Label();
       ...
       //     DrawTextCenterWS(g, "D", fFontS2, new SolidBrush(Color.FromArgb(64, 10, 10, 10)), kRIGHT ? new SolidBrush(Color.FromArgb(247, 190, 48)) : new SolidBrush(Color.FromArgb(120, 110, 101)), 113, 83);
            ...
            DrawTextCenterX(g, "Pooya Nasiri", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 552);
            DrawTextCenterX(g, "2018/01/20", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 566);
        }
        ...
        {
            g.FillRectangle(new SolidBrush(Color.FromArgb(120, 120, 120, 120)), rRect);
            ...
            DrawTextCenterXWS(g, "Author: Pooya Nasiri", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 250);
           // DrawTextCenterXWS(g, "Informatyka Inżynierska 2012-2016", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 290);
            DrawTextCenterXWS(g, "A I MATTER ©", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 310);
            DrawTextCenterXWS(g, "http://t.me/pooya_nasiri", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 350);
            DrawTextCenterXWS(g, "2017/01/20", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 370);
        }
